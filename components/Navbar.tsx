  ...
  return (
    <nav className="w-full fixed z-40">
      <div className={`px-4 md:px-16 py-6 flex flex-row items-center transition duration-500 ${showBackground ? 'bg-zinc-900 bg-opacity-90' : ''}`}>
        <Image src="/images/logo.png" className="h-4 lg:h-7 cursor-pointer" alt="Logo" width={100} height={100} />
        ...
        <div onClick={toggleMobileMenu} onBlur={() => setShowMobileMenu(false)} className="lg:hidden flex flex-row items-center gap-2 ml-8 cursor-pointer relative">
